...
/**
 * 未完成不能调用
 * Created by Berkeley on 3/16/17.
 */

public class WYXDanmakuVideoPlayer extends WYXVideoPlayer {
    ...
    public WYXDanmakuVideoPlayer(Context context) {
        super(context);
        initDanmaku();
    }

    public WYXDanmakuVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        initDanmaku();
    }

    public WYXDanmakuVideoPlayer(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initDanmaku();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WYXDanmakuVideoPlayer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
